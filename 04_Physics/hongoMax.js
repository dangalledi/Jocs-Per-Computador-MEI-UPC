...
function HomgoMax(x, y, map) {
	...
	var homgoMax = new Texture("imgs/hongos.png");

	// Prepare coin sprite & its homgoMax
	this.sprite = new Sprite(x, y, 32, 32, 2, homgoMax);
...
HomgoMax.prototype.update = function update(deltaTime) {
	if (this.live) {
...
HomgoMax.prototype.draw = function draw() {
	if(this.active) this.sprite.draw();
}

HomgoMax.prototype.collisionBox = function () {
...
HomgoMax.prototype.controlFormaBrick = function (ladrillos) {
