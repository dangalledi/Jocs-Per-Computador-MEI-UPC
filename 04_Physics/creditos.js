...
Creditos.prototype.update = function (deltaTime) {
    // Keep track of time
...
Creditos.prototype.draw = function () {
    ...
    text2 = "en la asignatura:  ";

    text3 = "Juegos por Computador - MEI";

    text4 = " Alexandra Olivares - Daniela Galleguillos";
    text5 = " <3 ";
    
    text6 = "FIB - Universitat Politècnica de Catalunya";
    ...
    context.fillText("", (canvas.width) / 2, 180);
context.fillText("", (canvas.width) / 2, 195);
    
var textSize6 = context.measureText(text6);
context.fillText(text6, (canvas.width- textSize6.width) / 2, 210);
    // Restore the context
    //context.restore();
}
